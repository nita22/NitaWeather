...
public class ChooseAreaActivity extends Activity{
    ...
    private NitaWeatherDB nitaWeatherDB;
    ...
    private void queryProvinces(){
        provinceList = nitaWeatherDB.loadProvinces();
    ...
    private void queryCities(){
        cityList = nitaWeatherDB.loadCities(selectedProvince.getId());
        if(cityList.size() > 0){
            dataList.clear();
    ...
    private void queryCounties(){
        countyList = nitaWeatherDB.loadCounties(selectedCity.getId());
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                ...
                if("province".equals(type)){
                    result = Utility.handleProvincesResponse(nitaWeatherDB, response);
                }else if ("city".equals(type)){
                    result = Utility.handleCitiesResponse(nitaWeatherDB, response, selectedProvince.getId());
                }else if("county".equals(type)){
                    result = Utility.handleCountiesResponse(nitaWeatherDB, response, selectedCity.getId());
                }
                if(result){

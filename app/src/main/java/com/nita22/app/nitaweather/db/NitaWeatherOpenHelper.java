...
public class NitaWeatherOpenHelper extends SQLiteOpenHelper{
    ...
    public NitaWeatherOpenHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version){
